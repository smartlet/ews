...
const (
	...
	UnindexedFieldURITypeCalendarLocation UnindexedFieldURIType = "calendar:SchemaLocation"
...
// Rule validation error code describing what failed validation for each rule predicate or
// action.
//
...
type SidAndAttributesType struct {
	...
	Attributes uint32 `xml:"http://schemas.microsoft.com/exchange/services/2006/types Attribute,attr,omitempty" json:"Attribute,omitempty"`
}
...
type ReminderType struct {
	...
	Location string `xml:"SchemaLocation,omitempty" json:"SchemaLocation,omitempty"`
...
type ClientAccessTokenRequestType struct {
	...
	IdentityAndEwsTokenId string `xml:"IdentityAndEwsTokenId,omitempty" json:"IdentityAndEwsTokenId,omitempty"`

	RequestedCapabilities string `xml:"RequestedCapabilities,omitempty" json:"RequestedCapabilities,omitempty"`

	SupportsSharedFolders bool `xml:"SupportsSharedFolders,omitempty" json:"SupportsSharedFolders,omitempty"`
}
...
type ClientExtensionType struct {
	...
	ExtensionId string `xml:"http://schemas.microsoft.com/exchange/services/2006/types ExtensionId,attr,omitempty" json:"ExtensionId,omitempty"`
}
...
type InboxReminderType struct {
	...
	RichTextMessage string `xml:"RichTextMessage,omitempty" json:"RichTextMessage,omitempty"`
}
...
type InstallAppType struct {
	...
	*BaseRequestType
	...
	IsMetaOSApp bool `xml:"IsMetaOSApp,omitempty" json:"IsMetaOSApp,omitempty"`

	MetaOSSyncData string `xml:"MetaOSSyncData,omitempty" json:"MetaOSSyncData,omitempty"`
}
...
type PrivateCatalogAddInsType struct {
	...
	InstallTimeInTicks int64 `xml:"http://schemas.microsoft.com/exchange/services/2006/messages InstallTimeInTicks,attr,omitempty" json:"InstallTimeInTicks,omitempty"`
}
